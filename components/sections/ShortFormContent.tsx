...
export function ShortFormContent() {
  ...
  return (
    <section
      ...
      className="relative bg-[hsl(var(--bg-primary))] section-y"
    >
      <div className="container-shell">
        <div className="mb-12 flex flex-col gap-3">
          ...
          <h2 className="fluid-h2 font-bold tracking-tight text-white text-balance font-sans">
            Reel stories built for fast attention
          </h2>
          <p className="fluid-body max-w-[52ch] text-[hsl(var(--text-muted))]">
          ...
          >
            {filteredReels.map((reel, index) => (
              <motion.article
                ...
                className="min-w-[260px] max-w-[340px] flex-[0_0_78%] 2xl:max-w-[380px] overflow-hidden rounded-3xl border border-[hsl(var(--border))] bg-[hsl(var(--bg-secondary))] shadow-[0_12px_40px_rgba(0,0,0,0.08)] transition-transform duration-300 hover:-translate-y-1 sm:flex-[0_0_42%] lg:flex-[0_0_28%] 2xl:flex-[0_0_22%] 3xl:flex-[0_0_18%] 4xl:flex-[0_0_15%]"
              >
